...
public class MapBuilder extends JFrame {
	 ...
	 * @throws IOException
	 */
	private void drawImage(int x, int y) throws IOException {
		if ((x == -1) && (y == -1))
	...
	/**
	 * Converts from a room number to an absolute location before calling
	 * drawPlayer with x and y coordinates
	 * 
	 * @param room
	 * @throws IOException
	 */
