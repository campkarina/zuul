...
public abstract class View extends JFrame implements ActionListener {
  ...
  public static View getInstance(Builder b) {
    ...
    View view;
    if (popup == 0) view = new TwoDView(b);
    else view = new ThreeDView(b);
    return view;
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    else if (e.getActionCommand().equals("Save")) saveGame(getFileName());
    else if (e.getActionCommand().equals("Load")) load(getFileNameForLoad());
    update();
  }
  ...
  private String getFileName() {
    ...
    if (fileName == null) return null; // the user did not want to save
    return fileName;
  }
  ...
  private void saveGame(String fileName) {
    ...
    try {
      ...
      oos.close();
      JOptionPane.showMessageDialog(this, "Your game was successfully saved!",
  ...
  protected void updateMapPanel() {
    ...
    if (p.getInventory().contains(new Item("Map", true))) {
      ...
      validate();
    } else mapLabel = new JLabel(new ImageIcon("Images/rooms_noMap.png"));
